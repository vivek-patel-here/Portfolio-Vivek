...
function DSA() {
return (
        <div className='h-screen w-screen bg-light  flex flex-col gap-10 items-center justify-between py-10'>
            ...
            <div className='h-8/10 w-8/10 flex items-center justify-center gap-10  flex-col px-10'>
                <img src="/LC.png" className='h-9/10 w-9/10 rounded-xl flex items-center justify-around border '/>
